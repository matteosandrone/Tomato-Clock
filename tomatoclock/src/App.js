...
class Counter extends React.Component {
 ...
 this.breakincrement = this.breakincrement.bind(this);
  ...
  this.sessionreset = this.sessionreset.bind(this);
  ...
  render() {
    return (
      <div>
        <button id='break-increment' onClick={this.breakincrement}>Increment!</button>
        <button id='break-decrement' onClick={this.breakdecrement}>Decrement!</button>
        <button id='session-increment' onClick={this.sessionincrement}>Increment!</button>
        <button id='session-decrement' onClick={this.sessiondecrement}>Decrement!</button>
       
        <h1 id='break-length'> {this.state.breakcount}</h1>
        <h1 id='session-length'> {this.state.sessioncount}</h1>

        <div id="timer-label">session</div>
        <div id="time-left">{this.clockify()}</div>
        <div id='start_stop'onClick={this.timercontrol}>start</div>
        <div id='reset' onClick={this.sessionreset}>reset</div>
      </div>
    );
  }
};
